...
import time
#/wallet/getexplain
interfaceNo = "getexplain"
name = "获取提现说明 "

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 获取提现说明(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取提现说明，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("wallet" + os.sep + "getexplain.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取提现说明成功"))
