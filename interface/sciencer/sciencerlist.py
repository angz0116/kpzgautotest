...
interfaceNo = "sciencerlist"
name = "获取科普员列表信息"

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 获取科普员列表信息(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取科普员列表信息，token==" + str(self.token))
		# 获取json字符串科普员
		self.data = jsondata("sciencer" + os.sep + "sciencerlist.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取科普员列表信息成功"))
