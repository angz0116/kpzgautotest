...
interfaceNo = "sciencerstatus"
name = "科普员信息修改审核状态 "

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 科普员信息修改审核状态 (unittest.TestCase):
	...
	def test_body(self):
		...
		print("科普员信息修改审核状态，token==" + str(self.token))
		# 获取json字符串科普员
		self.data = jsondata("sciencer" + os.sep + "sciencerstatus.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否科普员信息修改审核状态成功"))
