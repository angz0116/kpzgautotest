...
import time
#/article/browseclear
interfaceNo = "browseclear"
name = "获取清除浏览记录"

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 获取清除浏览记录(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取清除浏览记录，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("article" + os.sep + "browseclear.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取清除浏览记录成功"))
