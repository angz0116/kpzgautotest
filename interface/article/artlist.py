...
class 获取各个分类资讯列表(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取各个分类资讯列表，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("article" + os.sep + "artlist.json")
		self.data["ac_id"] = self.atid
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取各个分类资讯列表成功"))
