...
class 获取浏览记录(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取浏览记录，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("article" + os.sep + "ebrowse.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取浏览记录成功"))
