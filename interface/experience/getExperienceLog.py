...
interfaceNo = "getUserExperience"
name = "获取用户经验详情"

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 获取用户经验详情(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取用户经验详情，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("experience" + os.sep + "getUserExperience.json")
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取用户经验详情成功"))
