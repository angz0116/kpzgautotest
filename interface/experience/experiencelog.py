...
interfaceNo = "experiencelog"
name = "获取经验日志"

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 获取经验日志(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取经验日志，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("experience" + os.sep + "experiencelog.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取经验日志成功"))
