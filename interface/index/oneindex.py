...
interfaceNo = "oneindex"
name = "获取首页信息"

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 获取首页信息(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取首页信息，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("index" + os.sep + "oneindex.json")
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取首页信息成功"))
