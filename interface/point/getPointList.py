...
class 积分添加消耗日志(unittest.TestCase):
	...
	def test_body(self):
		...
		print("积分添加消耗日志，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("point" + os.sep + "getPointList.json")
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否积分添加消耗日志成功"))
