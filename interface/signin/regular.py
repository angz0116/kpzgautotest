...
class 获取签到积分规则(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取签到积分规则，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("signin" + os.sep + "regular.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取签到积分规则成功"))
