...
interfaceNo = "signinswitch"
name = "获取签到开关"

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 获取签到开关(unittest.TestCase):
	...
	def test_body(self):
		...
		print("获取签到开关，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("signin" + os.sep + "signinswitch.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否获取签到开关成功"))
