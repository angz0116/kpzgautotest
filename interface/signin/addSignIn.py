...
#/signin/addSignIn
interfaceNo = "addSignIn"
name = "添加签到信息"

req = ConfigHttp()

@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 添加签到信息(unittest.TestCase):
	...
	def test_body(self):
		...
		print("添加签到信息，token==" + str(self.token))
		# 获取json字符串
		self.data = jsondata("signin" + os.sep + "addSignIn.json")
		print(self.data)
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, 0, self.logger.info("检查是否添加签到信息成功"))
